...
7. **Single-scan exclude resolution**: The `--exclude-note` filter resolves all exclusions in one metadata scan. It also verifies the existence of each excluded note for the typo warning.
